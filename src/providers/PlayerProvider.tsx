...
export function PlayerProvider({children}: { children: ReactNode }) {
    ...
    const contextValue = useMemo<PlayerContextType>(() => ({
        ...
        currentItem, streamInfo, isPlaying, position, duration, volume,
        isMuted, isFullscreen, selectedSubtitleId, selectedAudioId, quality, isDrawerOpen,
        queue, queueIndex, isQueueActive, isShuffled,
        addToQueue, playNext, removeFromQueue, clearQueue, playFromQueue,
        advanceQueue, retreatQueue, syncQueueIndex, toggleShuffle,
    ]);
